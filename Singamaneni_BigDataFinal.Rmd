...
ggplot(Data_Ind, aes(Race..Ethnicity ,Indicator.Category,  color= Gender))+ geom_point()+geom_line()


#Analysis on Drinking data for high school students

ggplot(drink.ad, aes( Ethnicity,Place, color = Year ))+geom_boxplot()+geom_point()
...
ggplot(smoke.st, aes(Year, Place , color = Ethnicity))+geom_boxplot()+geom_point()
...
#Adults smoke data
ggplot(smoke.ad, aes(Ethnicity, Place, color = Year))+geom_boxplot()+geom_point()
